...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        retVal = armnn::test::ClassifierInferenceTestMain<DatabaseType, ParserType>(
                    argc, argv, "mobilenet_v2.caffemodel", true,
                    "data", "prob", { 0 },
                    [&imageSet](const char* dataDir, const ModelType&) {
                        return DatabaseType(dataDir, 224, 224, imageSet, 1, {{128, 128, 128}}, {{128, 128, 128}}, DatabaseType::DataFormat::NCHW, 1);
                    });
    }
