...
BOOST_AUTO_TEST_CASE(IsConvertFp16ToFp32SupportedReference)
{
    ...
    bool result = IsConvertLayerSupportedTests<armnn::NpuWorkloadFactory, armnn::ConvertFp16ToFp32Layer,
...
BOOST_AUTO_TEST_CASE(IsConvertFp32ToFp16SupportedReference)
{
    ...
    bool result = IsConvertLayerSupportedTests<armnn::NpuWorkloadFactory, armnn::ConvertFp32ToFp16Layer,
